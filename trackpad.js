...
async function showNumbers() {
    ...
    divOut = document.getElementById("pis");
    // document.getElementById("pis").innerHTML = CLASS_MAPPING[num];
    divOut.textContent = CLASS_MAPPING[num]
